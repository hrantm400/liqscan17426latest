...
export function Monitor3OB() {
    ...
    const has3ObAccess = hasFeature('crt') || hasFeature('3_ob');
    const isTierPaid = hasFullProductAccess || has3ObAccess;
    const isSymbolAllowed = useCallback(
        (symbol: string) =>
            isTierPaid || baseIsSymbolAllowed(symbol, 'crt') || baseIsSymbolAllowed(symbol, '3_ob'),
        [isTierPaid, baseIsSymbolAllowed],
    );
            ...
            {isLoading && (
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-background-dark/50 backdrop-blur-sm">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-primary font-mono font-bold animate-pulse">Scanning 3-OB Signals...</p>
                    </div>
                </div>
            )}
                                    ...
                                    <table className="hidden md:table w-full text-sm text-left dark:text-gray-400 light:text-text-light-secondary">
                                        <thead className="text-[11px] uppercase dark:text-gray-500 light:text-text-light-secondary font-bold sticky top-0 dark:bg-[#0a140d] light:bg-green-50 dark:border-b-white/10 light:border-b-green-300 z-10 tracking-wider">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-right" scope="col">Lowest Low</th>
                                                <th className="px-6 py-3 text-right" scope="col">Highest High</th>
                                        ...
                                        <tbody className="dark:divide-y-white/5 light:divide-y-green-200/30 text-xs font-medium">
                                            {paginatedSignals.length === 0 ? (
                                                <tr>
                                                    <td colSpan={12} className="px-6 py-12 text-center dark:text-gray-500 light:text-text-light-secondary">
                                                        No signals found
                                                    </td>
                                                </tr>
                                            ) : (
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td className={`px-6 py-2.5 text-right font-mono text-xs dark:text-gray-300 light:text-gray-600 ${isLocked ? 'blur-[5px] select-none pointer-events-none' : ''}`}>
                                                                {meta.lowestlow != null ? formatPrice(meta.lowestlow) : '—'}
                                                            </td>
                                                            <td className={`px-6 py-2.5 text-right font-mono text-xs dark:text-gray-300 light:text-gray-600 ${isLocked ? 'blur-[5px] select-none pointer-events-none' : ''}`}>
                                                                {meta.highesthigh != null ? formatPrice(meta.highesthigh) : '—'}
                                                            </td>
                                                    ...
                                                    >
                                                        ...
                                                        <div className={`flex flex-col gap-1 text-xs mb-1 ${isLocked ? 'blur-[5px] select-none pointer-events-none' : ''}`}>
                                                            <div className="flex justify-between">
                                                                <span className="dark:text-gray-500 light:text-slate-500">OB range:</span>
                                                                <span className="font-mono">
                                                                    {meta.lowestlow != null && meta.highesthigh != null
                                                                        ? `${formatPrice(meta.lowestlow)} – ${formatPrice(meta.highesthigh)}`
                                                                        : '—'}
                                                                </span>
                                                            </div>
                                                            <div className="flex justify-between">
                                                ...
                                                >
                                                    ...
                                                    <div className={`p-4 flex justify-between items-center text-sm mt-auto z-10 dark:bg-black/30 ${isLocked ? 'blur-[5px] select-none pointer-events-none' : ''}`}>
                                                        ...
                                                        <div className="flex flex-col gap-1 w-full">
                                                            <div className="flex justify-between items-center text-xs">
                                                                <span className="dark:text-gray-500 light:text-gray-400">Lowest low:</span>
                                                                <span className="dark:text-white font-mono">{meta.lowestlow != null ? formatPrice(meta.lowestlow) : '—'}</span>
                                                            </div>
                                                            <div className="flex justify-between items-center text-xs">
                                                                <span className="dark:text-gray-500 light:text-gray-400">Highest high:</span>
                                                                <span className="dark:text-white font-mono">{meta.highesthigh != null ? formatPrice(meta.highesthigh) : '—'}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className={`px-4 py-2 dark:bg-black/40 light:bg-green-50 dark:border-t-white/5 light:border-t-green-300 flex justify-between items-center z-10 relative ${isLocked ? 'blur-[5px] select-none pointer-events-none' : ''}`}>
                                                        <div className="flex items-center gap-1.5">
                                                            <span className="text-[10px] text-primary font-bold uppercase">3-OB</span>
                                                        </div>
                                                        {!isLocked && <button
                                                            onClick={(e) => {
                                                                e.stopPropagation();
